        ...
        <section id='works'>
            <div className='max-w-7xl mx-auto px-4'>
                <motion.div
                    ...
                    className='text-center mb-12 borer-t border-neutral-800'>
            ...
            <motion.div initial='hidden' whileInView='visible' variants={{
                ...
                className='max-w-7xl mx-auto px-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                    ...
                    <motion.div
                        ...
                        {step.users && (
                            <div className='flex justify-between items-center mt-4'>
                                ...
                                <button type='button' className='bg-blue-600 hover:bg-blue-500 text-white py-2 px-4 rounded-lg'>Connect</button>
                            </div>
                        )}
                    </motion.div>
                ))}
