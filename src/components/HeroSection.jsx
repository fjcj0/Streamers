    ...
    return (
        <motion.section variants={containerVariants} initial='hidden' animate='visible' className='pt-28 lg:pt-36'>
            <div className='max-w-7xl mx-auto px-4 flex flex-col items-center text-center'>
                ...
                <motion.h1 variants={fadeInUp} className='text text-5xl lg:text-8xl my-4 font-semibold tracking-tighter bg-gradient-to-b from-neutral-50 via-neutral-300 to-neutral-700 bg-clip-text text-transparent '>
                ...
                <motion.div variants={fadeIn} className='mt-12'>
                    <img src={heroImage} alt='Streamer SaaS Interface' className='w-full h-auto rounded-3xl borer border-neutral-800  mb-20' />
                </motion.div>
            </div>
        </motion.section>
    );
